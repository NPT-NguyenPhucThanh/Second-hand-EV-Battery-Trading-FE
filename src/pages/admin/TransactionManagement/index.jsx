            ...
            >
              <div className="flex gap-4 mb-4">
                ...
                <div className="flex flex-col">
                  ...
                  <div
                    className={`mt-1 px-3 py-1 rounded-lg flex items-center gap-2 ${status.color}`}
                  >
              ...
              <div className="flex items-center gap-2 mb-4">
               ...
               {(order.status === ORDER_STATUS.DA_DAT_COC || order.status === ORDER_STATUS.DA_DUYET ) && (
                <div className="border-t border-gray-400/20 pt-4 pb-4">
                  <div className="mb-3 text-blue-600 font-semibold">
                    Đã đặt cọc:{" "}
                    {calculateDeposit(order).toLocaleString("vi-VN")} đ (10%)
                  </div>
                </div>
              )}
          ...
          return (
            ...
            >
              ...
              >
                ...
                <div className="border-t border-gray-400/20 pt-4 pb-4">
                  <p>
                    <strong>Người mua:</strong> {o.users.displayname} (
                    {o.users.username})
                  </p>
                ...
                <div className="border-t border-gray-400/20 pt-4 pb-4">
                  {(o.status === ORDER_STATUS.DA_DAT_COC || o.status === ORDER_STATUS.DA_DUYET ) && (
                    <p>
                      <strong>Đã đặt cọc (10%):</strong>{" "}
                      {calculateDeposit(o).toLocaleString("vi-VN")} đ
                    </p>
                  )}
                  ...
                  <p>
                    <strong>Ngày tạo:</strong> {formatDateTime(o.createdat)}
                  </p>
                  <p>
