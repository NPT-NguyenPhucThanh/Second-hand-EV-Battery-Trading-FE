...
import {
    getProductPendingApproval,
    getProductPendingInsspection,
    approveProduct,
    inputInspection
    ...
    return (
        <div className={`min-h-screen p-6 ${isDark ? "bg-gray-900" : "bg-gray-50"}`}>
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className={`px-3 py-1 rounded-lg ${
                                ...
                                <span className="text-xs font-medium">
                                    {activeTab === 'approval' ? "Sơ bộ" : "Kiểm định"}
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2 mb-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className={`text-xl font-bold ${isDark ? "text-green-400" : "text-green-500"}`}>
                        ...
                        <div className="flex gap-2">
                            ...
                            <button
                                onClick={() => handleApprove(product.productid, product.productname)}
                                className={`flex-1 py-2 rounded-lg font-medium transition-all flex items-center justify-center gap-2 ${
                                    isDark
                            ...
                            <button
                                ...
                                className="flex-1 py-2 rounded-lg font-medium transition-all flex items-center justify-center gap-2 bg-red-500 text-white hover:bg-red-600"
                            >
            ...
            {isRejectModalVisible && selectedProduct && (
                ...
                >
                    <div
                        className={`rounded-2xl p-6 max-w-lg w-full ${isDark ? "bg-gray-800" : "bg-white"}`}
                    ...
                    >
                        ...
                        <p className={`mb-4 ${isDark ? "text-gray-300" : "text-gray-700"}`}>
                            <strong>Sản phẩm:</strong> {selectedProduct.productname}
                        </p>
                        ...
                        <textarea
                            rows={3}
                            placeholder="Ví dụ: Thông tin không chính xác..."
                            value={note}
                        ...
                        <div className="flex gap-3 mt-6">
                            ...
                            <button
                                ...
                                className="flex-1 py-2 rounded-lg font-medium transition-all bg-red-500 text-white hover:bg-red-600"
                            >
                                Xác nhận từ chối
                            </button>
                        </div>
